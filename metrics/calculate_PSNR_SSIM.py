...
def main():
    ...
    folder_GT = '/home/haoyu-z/Downloads/mmsr-master/datasets/Set14'
    folder_Gen = '/home/haoyu-z/Downloads/mmsr-master/datasets/bic/Bic/x3'
    ...
    for i, img_path in enumerate(img_list):
        ...
        im_Gen = cv2.imread(os.path.join(folder_Gen, base_name + suffix + '.bmp')) / 255.
        ...
        # crop borders
        im_GT_in = util.modcrop(im_GT_in, 3)
        if im_GT_in.ndim == 3:
